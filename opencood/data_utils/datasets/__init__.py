...
from opencood.data_utils.datasets.intermediate_fusion_dataset_graph import IntermediateFusionDatasetGraph
...
__all__ = {
    ...
    'IntermediateFusionDatasetGraph':IntermediateFusionDatasetGraph
}
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert dataset_name in ['LateFusionDataset', 'EarlyFusionDataset',
                            'IntermediateFusionDataset', 'IntermediateFusionDatasetV2','IntermediateFusionDatasetGraph'], error_message
